...
// This just provides a way of hiding key values
...
public class Key
{
	...
	public static final int CONTROL_LEFT = Keys.CONTROL_LEFT;
	public static final int CONTROL_RIGHT = Keys.CONTROL_RIGHT;
	public static final int SHIFT_LEFT = Keys.SHIFT_LEFT;
	public static final int SHIFT_RIGHT = Keys.SHIFT_RIGHT;
	public static final int BACKSPACE = Keys.BACKSPACE;
	public static final int DELETE = Keys.DEL;
	...
	public static final int DIGIT_0 = Keys.NUM_0;
	public static final int DIGIT_1 = Keys.NUM_1;
	public static final int DIGIT_2 = Keys.NUM_2;
	public static final int DIGIT_3 = Keys.NUM_3;
	public static final int DIGIT_4 = Keys.NUM_4;
	public static final int DIGIT_5 = Keys.NUM_5;
	public static final int DIGIT_6 = Keys.NUM_6;
	public static final int DIGIT_7 = Keys.NUM_7;
	public static final int DIGIT_8 = Keys.NUM_8;
	public static final int DIGIT_9 = Keys.NUM_9;
	
	public static final int NUMPAD_ADD = Keys.PLUS;
	public static final int NUMPAD_DECIMAL = Keys.PERIOD;
	public static final int NUMPAD_DIVIDE = Keys.SLASH;
	public static final int NUMPAD_ENTER = Keys.ENTER;
	public static final int NUMPAD_MULTIPLY = Keys.STAR;
	public static final int NUMPAD_SUBTRACT = Keys.MINUS;
}
